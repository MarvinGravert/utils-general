...
class SimpelComStub(object):
    ...
    def __init__(self, channel):
        ...
        self.NumberTrade = channel.unary_unary(
                ...
                request_serializer=bidirectional__pb2.SimpleCall.SerializeToString,
                response_deserializer=bidirectional__pb2.SimpleResponse.FromString,
                )
...
def add_SimpelComServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'NumberTrade': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=bidirectional__pb2.SimpleCall.FromString,
                    response_serializer=bidirectional__pb2.SimpleResponse.SerializeToString,
            ),
    }
...
class SimpelCom(object):
    ...
    def NumberTrade(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/SimpelCom/NumberTrade',
            bidirectional__pb2.SimpleCall.SerializeToString,
            bidirectional__pb2.SimpleResponse.FromString,
